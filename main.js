...
Array.prototype.splice = function(){
    ...
    const helperArray = [...this];
    let startIndex = (arguments[0])?arguments[0]:0;
    let deleteCount = (arguments[1])?arguments[1]:originalLength;
    (arguments[1]===0)&&(deleteCount=0)

    //console.log(`Start at ${startIndex}`)
    //console.log(`Remove ${deleteCount} Items`)
    ...
    for(let i=0; i<originalLength; i++){
      ...
      if(!hasEntered&&i===startIndex){
        ...
        hasEntered = true;
        //startIndex += itemsToEnter.length
      }
    ...
    //console.log(`Enter: ${[...itemsToEnter]}`)
